...
def run_dataset(
    ...
    """ggplot(df, aes('dose','observed probability') +
    geom_point() +
    scale_x_log10() +
    labs(title='', x='Dose', y='Probability of Response')"""
